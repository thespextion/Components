...
A collection of beautiful, animated 3D buttons for React Native, Expo, and React applications with TypeScript support.

## Features

- 🎨 **10 Beautiful Variants** - From default to AI-themed styles
- 📏 **5 Size Options** - xs, sm, default, lg, and icon
- ✨ **Smooth Animations** - Built with React Native Reanimated
- 🎯 **TypeScript Support** - Full type safety
- 📱 **Cross-Platform** - Works with React Native, Expo, and React
...
If you like this project, please give it a ⭐ on [GitHub](https://github.com/thespextion/Components)!
